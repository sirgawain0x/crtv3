...
import { catchError, distinctUntilKeyChanged, EMPTY, Observable, Subject, takeUntil, concatMap, map, } from 'rxjs';
...
export class Repository {
    constructor(cacheLimit, concurrencyLimit, feed, logger) {
        this.logger = logger;
    ...
    _registerRunningState(state$) {
        state$
            .pipe(distinctUntilKeyChanged('log', (currentLog, proposedLog) => {
            if (proposedLog.length !== currentLog.length)
                return false;
