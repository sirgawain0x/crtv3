...
import { CreateOpts, Stream, StreamHandler, Context, LoadOpts, CeramicApi, CeramicCommit, IpfsApi, MultiQuery, PinningBackendStatic, LoggerProvider, UpdateOpts, SyncOptions, AnchorStatus, StreamState, AdminApi, NodeStatusResponse, AnchorOpts } from '@ceramicnetwork/common';
...
export declare class Ceramic implements CeramicApi {
    ...
    private readonly anchorResumingService;
