...
class GraphQLServer extends Command {
    async run() {
        try {
...
_define_property(GraphQLServer, "description", 'Load the graphQL schema from Composite ');
_define_property(GraphQLServer, "args", {
    runtimeDefinitionPath: Args.string({
        required: false,
        description: 'ID of the stream'
    })
});
_define_property(GraphQLServer, "flags", {
    ...Command.flags,
