...
class CompositeModels extends Command {
    async run() {
        try {
            ...
            if (this.stdin !== undefined) {
                ...
                this.spinner.fail('You need to pass a path to encoded composite either via an arg or through stdin');
                return;
            }
            ...
            if (this.flags['id-only'] === true) {
                ...
                Object.entries(internalDefinition.models).map(([modelStreamID, modelDefinition])=>{
                    table.push([
                        ...
                        modelStreamID,
                        internalDefinition.aliases && internalDefinition.aliases[modelStreamID] ? internalDefinition.aliases[modelStreamID] : '(none)',
                ...
                Object.entries(internalDefinition.models).map(([modelStreamID, modelDefinition])=>{
                    ...
                    if (internalDefinition.aliases && internalDefinition.aliases[modelStreamID] !== undefined) {
...
_define_property(CompositeModels, "description", 'display the list of models included in a composite');
_define_property(CompositeModels, "args", {
    compositePath: Args.string({
        required: false,
        description: 'A path to encoded composite definition'
    })
});
_define_property(CompositeModels, "flags", {
    ...Command.flags,
...
export { CompositeModels as default };
