import type { BaseQuery, IndexApi, ModelData, Page, PaginationQuery, StreamState, DiagnosticsLogger, StreamStateLoader, StreamReader } from '@ceramicnetwork/common';
...
export declare class LocalIndexApi implements IndexApi {
    ...
    constructor(indexingConfig: IndexingConfig | undefined, reader: StreamReader, loader: StreamStateLoader, logger: DiagnosticsLogger, networkName: Networks);
