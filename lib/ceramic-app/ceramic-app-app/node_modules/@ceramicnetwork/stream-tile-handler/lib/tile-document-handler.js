...
import { AnchorStatus, EventType, EnvironmentUtils, SignatureStatus, StreamUtils, } from '@ceramicnetwork/common';
...
export class TileDocumentHandler {
    ...
    async _applyGenesis(commitData, context) {
        ...
        if (isSigned) {
            ...
            await SignatureUtils.verifyCommitSignature(commitData, context.signer, controllers[0], null, streamId);
        }
    ...
    async _applySigned(commitData, state, context) {
        ...
        await SignatureUtils.verifyCommitSignature(commitData, context.signer, controller, null, streamId);
