import { CreateOpts, Stream, LoadOpts, UpdateOpts, RawCommit, GenesisCommit, StreamMetadata, StreamWriter, StreamReader } from '@ceramicnetwork/common';
...
export declare class Caip10Link extends Stream {
    ...
    static fromAccount(ceramic: StreamWriter, accountId: string | AccountId, opts?: CreateOpts | LoadOpts): Promise<Caip10Link>;
    static fromGenesis(ceramic: StreamWriter, genesisCommit: GenesisCommit, opts?: CreateOpts | LoadOpts): Promise<Caip10Link>;
    ...
    static load(ceramic: StreamReader, streamId: StreamID | CommitID | string, opts?: LoadOpts): Promise<Caip10Link>;
