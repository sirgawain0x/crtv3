...
import { CreateOpts, CeramicCommit, Stream, StreamConstructor, StreamHandler, LoadOpts, MultiQuery, PinApi, UpdateOpts, AnchorStatus, IndexApi, StreamState, AdminApi, AnchorOpts, CeramicSigner, StreamReaderWriter } from '@ceramicnetwork/common';
import { StreamID, CommitID } from '@ceramicnetwork/streamid';
export declare const DEFAULT_CLIENT_CONFIG: CeramicClientConfig;
export interface CeramicClientConfig {
    syncInterval: number;
}
export declare class CeramicClient implements StreamReaderWriter {
