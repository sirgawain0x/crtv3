...
export declare function validateImplementedInterfaces(model: ModelDefinition, context: StreamReader): Promise<void>;
export declare function isValidImmutabilityImplementation(expected: ModelDefinition, implemented: ModelDefinition): boolean;
