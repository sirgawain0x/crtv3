...
const BOOTSTRAP_LIST = (ceramicNetwork) => {
    if (!EnvironmentUtils.useRustCeramic()) {
        ...
        switch (ceramicNetwork) {
            case Networks.MAINNET:
                return [
                    multiaddr('/dns4/bootstrap-mainnet-rust-ceramic-1.3box.io/tcp/4101/p2p/12D3KooWJC1yR4KiCnocV9kuAEwtsMNh7Xmu2vzqpBvk2o3MrYd6'),
                    multiaddr('/dns4/bootstrap-mainnet-rust-ceramic-2.3box.io/tcp/4101/p2p/12D3KooWCuS388c1im7KkmdrpsLMziihF8mbcv2w6HPCp4Qmww6m'),
                ];
            case Networks.TESTNET_CLAY:
                return [
                    multiaddr('/dns4/bootstrap-tnet-rust-ceramic-1.3box.io/tcp/4101/p2p/12D3KooWMqCFj5bnwuNi6D6KLhYiK4C8Eh9xSUKv2E6Jozs4nWEE'),
                    multiaddr('/dns4/bootstrap-tnet-rust-ceramic-2.3box.io/tcp/4101/p2p/12D3KooWPFGbRHWfDaWt5MFFeqAHBBq3v5BqeJ4X7pmn2V1t6uNs'),
                ];
            case Networks.DEV_UNSTABLE:
                return [
                    multiaddr('/dns4/bootstrap-devqa-rust-ceramic-1.3box.io/tcp/4101/p2p/12D3KooWJmYPnXgst4gW5GoyAYzRB3upLgLVR1oDVGwjiS9Ce7sA'),
                    multiaddr('/dns4/bootstrap-devqa-rust-ceramic-2.3box.io/tcp/4101/p2p/12D3KooWFCf7sKeW8NHoT35EutjJX5vCpPekYqa4hB4tTUpYrcam'),
                ];
            case Networks.LOCAL:
            case Networks.INMEMORY:
                return null;
