...
__decorate([
    ...
    __metadata("design:type", Number)
], IndexingConfig.prototype, "maxConnectionPoolSize", void 0);
...
let DaemonMetricsConfig = class DaemonMetricsConfig {
    constructor() {
        this.metricsPublisherEnabled = false;
    }
};
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Boolean)
], DaemonMetricsConfig.prototype, "metricsPublisherEnabled", void 0);
__decorate([
    jsonMember(Number, { name: 'metrics-publish-interval-ms' }),
    __metadata("design:type", Number)
], DaemonMetricsConfig.prototype, "metricsPublishIntervalMS", void 0);
