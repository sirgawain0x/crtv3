...
import { readEncodedComposite, writeEncodedComposite, writeEncodedCompositeRuntime } from "@composedb/devtools-node";
...
(async ()=>{
    ...
    const metricComposite = await createMetricComposite(ceramic);
