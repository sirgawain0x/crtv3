...
description: You can get Joyride's state changes using the callback prop.
---
...
You can read more about the constants [here](https://docs.react-joyride.com/constants)
