...
description: The only required prop is steps with an array of steps.
---

# Props

The only required prop is `steps` with an array of [steps](https://docs.react-joyride.com/step).\
...
A React component to use instead of the default Beacon. Check [custom components](https://docs.react-joyride.com/custom-components) for details.
...
The tour's steps.\
Check the [step](https://docs.react-joyride.com/step) docs for more information.

**styles** `Partial<Styles>`\
Override the [styling](https://docs.react-joyride.com/styling) of the Tooltip

**tooltipComponent** `ElementType<TooltipRenderProps>`\
A React component to use instead of the default Tooltip. Check [custom components](https://docs.react-joyride.com/custom-components) for details.
