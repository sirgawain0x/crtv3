...
description: The step is a plain object that only requires two properties to be valid: target and content.
---
...
Override the [styling](https://docs.react-joyride.com/styling) of the step's Tooltip
...
Step will inherit some properties from Joyride's own [props](https://docs.react-joyride.com/props), but you can override them:
