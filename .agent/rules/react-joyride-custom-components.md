...
description: You can use custom components to have complete control of the UI.
---
...
{% hint style="info" %}
If you want to customize the default UI, check the [styling](https://docs.react-joyride.com/styling) docs.
{% endhint %}
