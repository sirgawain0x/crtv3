...
description: Ponder natively supports SQL queries over HTTP using the @ponder/client and @ponder/react packages.
---
...
Get all `pool` records with a `chainId` of `1` and a `fee` of `0` and