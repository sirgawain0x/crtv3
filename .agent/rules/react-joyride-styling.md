...
description: Version 2 uses inline styles instead of V1 SCSS.
---
...
Or, if you need finer control, you can use your own components for the beacon and tooltip. Check the [custom components](https://docs.react-joyride.com/custom-components) documentation.
