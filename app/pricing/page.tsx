        ...
        >
          <VStack alignItems="center" w="full">
            ...
            <Text mb={5} textAlign="center">
              ...
              tailored membership plans. Whether you&apos;re here to explore,
          ...
          >
            <Box
              as={Button}
              backgroundColor={!isAnnual ? '#EC407A' : 'inherit'}
          ...
          >
            {!isAnnual
              ? aPrices.map((price) => (
                  <PricingBoxA key={price.name} {...price} />
                ))
              : bPrices.map((price) => (
                  <PricingBoxB key={price.name} {...price} />
                ))}
          </Grid>
        </Stack>
      </Flex>
