            ...
            <div className="absolute left-0 right-0 top-0 bg-gradient-to-b from-black/60 to-transparent pt-2">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Player.FullscreenTrigger className="group relative flex h-8 w-8 cursor-pointer touch-none items-center justify-center rounded-full bg-black/50 hover:bg-black/70">
                  ...
                  <Player.PictureInPictureTrigger className="group relative flex h-8 w-8 cursor-pointer touch-none items-center justify-center rounded-full bg-black/50 hover:bg-black/70">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="flex items-center gap-4">
                <Player.PlayPauseTrigger
                  className="group relative flex h-12 w-12 cursor-pointer touch-none items-center justify-center rounded-full bg-black/50 hover:bg-black/70"
                ...
                <Player.MuteTrigger
                  className="group relative flex h-10 w-10 cursor-pointer touch-none items-center justify-center rounded-full bg-black/50 hover:bg-black/70"
                  onClick={handleControlInteraction}
                >
