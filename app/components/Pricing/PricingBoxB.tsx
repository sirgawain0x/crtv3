...
const PricingBoxB: React.FC<PricingBoxProps> = ({
  popular = false,
  name,
  price,
  info = '',
  ...
  return (
    ...
    >
      ...
      <HStack>
        <Heading color={useColorModeValue('gray.600', 'white')}>
          {price ?? 'Free'}
        </Heading>
        {price && (
          <Box as="span">
      ...
      <Box>
        ...
        <Text color={useColorModeValue('gray.600', 'white')} fontSize="xs">
          {info}
        </Text>
      </Box>
    </Stack>
