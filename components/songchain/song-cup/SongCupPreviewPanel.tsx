  ...
  return (
    <div className={cn("flex h-full flex-col gap-6", className)}>
      <div className="space-y-2">
        <h2 className="text-2xl font-black uppercase italic tracking-wide text-white">
          {title}
        </h2>
        {description ? (
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        <div className="space-y-4 rounded-xl border border-fuchsia-500/20 p-5">
        ...
        {showVideo && (
          <div className="rounded-xl border border-fuchsia-500/20 p-4">
            <div className="aspect-video w-full rounded-lg bg-gradient-to-br from-fuchsia-950/60 to-violet-950/60 flex items-center justify-center">
              <span className="text-sm font-medium text-fuchsia-200">Video preview placeholder</span>
            </div>
